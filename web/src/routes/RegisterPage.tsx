...
import { ValidationErrorList, FieldError, type FieldValidationError } from '../components/bookings/ValidationErrorList';
...
export function RegisterPage() {
  ...
  const [validationErrors, setValidationErrors] = useState<FieldValidationError[] | null>(null);
      ...
      <form onSubmit={handleSubmit}>
        <label>
          ...
          {/* Field-level errors render right next to the input they
              ...
              dropped). */}
          <FieldError errors={validationErrors ?? undefined} field="email" />
        </label>
        <label>
          ...
          <input
            ...
            required
          />
          <FieldError errors={validationErrors ?? undefined} field="password" />
        </label>
        <ValidationErrorList errors={validationErrors ?? undefined} knownFields={['email', 'password']} />
